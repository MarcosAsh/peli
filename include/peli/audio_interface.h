...
#ifndef PELI_AUDIO_INTERFACE_H
#define PELI_AUDIO_INTERFACE_H
...
namespace peli {
    ...
    PELI_DLL AudioReaderPtr GetAudioReader(std::string fname, int sampleRate, DLContext ctx, int io_type, bool mono);
}
