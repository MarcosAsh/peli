 ...
 * \file peli/runtime/serializer.h
 * \brief Serializer extension to support PELI data types
 *  Include this file to enable serialization of DLDataType, DLContext
 */
#ifndef PELI_RUNTIME_SERIALIZER_H_
#define PELI_RUNTIME_SERIALIZER_H_
...
#endif  // PELI_RUNTIME_SERIALIZER_H_
