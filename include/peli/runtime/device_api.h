 ...
 * \file peli/runtime/device_api.h
 * \brief Abstract device memory management API
 */
#ifndef PELI_RUNTIME_DEVICE_API_H_
#define PELI_RUNTIME_DEVICE_API_H_
...
/*!
 *  \brief PELI Runtime Device API, abstracts the device
 *  specific interface for memory management.
 */
class PELI_DLL DeviceAPI {
 public:
   ...
   */
  virtual void SetDevice(PELIContext ctx) = 0;
  /*!
   ...
   * \sa DeviceAttrKind
   */
  virtual void GetAttr(PELIContext ctx, DeviceAttrKind kind, PELIRetValue* rv) = 0;
  /*!
   ...
   */
  virtual void* AllocDataSpace(PELIContext ctx,
                               size_t nbytes,
                               size_t alignment,
                               PELIType type_hint) = 0;
  /*!
   * \brief Free a data space on device.
   * \param ctx The device context to perform operation.
   * \param ptr The data space.
   */
  virtual void FreeDataSpace(PELIContext ctx, void* ptr) = 0;
  /*!
  ...
  virtual void CopyDataFromTo(const void* from,
                              ...
                              PELIContext ctx_to,
                              PELIType type_hint,
                              PELIStreamHandle stream) = 0;
    /*!
   * \brief Create a new stream of execution.
   *
   * \param ctx The context of allocation.
   */
  virtual PELIStreamHandle CreateStream(PELIContext ctx);
   ...
   */
  virtual void FreeStream(PELIContext ctx, PELIStreamHandle stream);
   ...
   */
  virtual void StreamSync(PELIContext ctx, PELIStreamHandle stream) = 0;
  /*!
   * \brief Set the stream
   * \param ctx The context to set stream.
   * \param stream The stream to be set.
   */
  virtual void SetStream(PELIContext ctx, PELIStreamHandle stream) {}
  /*!
   ...
   */
  virtual void SyncStreamFromTo(PELIContext ctx,
   ...
   */
  virtual void* AllocWorkspace(PELIContext ctx,
                                       size_t nbytes,
                                       PELIType type_hint = {});
  /*!
   ...
   */
  virtual void FreeWorkspace(PELIContext ctx, void* ptr);
   ...
   */
  static DeviceAPI* Get(PELIContext ctx, bool allow_missing = false);
};
...
#endif  // PELI_RUNTIME_DEVICE_API_H_
