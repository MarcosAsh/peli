 ...
 * \file peli/runtime/module.h
 * \brief Runtime container of the functions generated by PELI,
 *  This is used to support dynamically link, load and save
 *  functions from different convention under unified API.
 */
#ifndef PELI_RUNTIME_MODULE_H_
#define PELI_RUNTIME_MODULE_H_
...
/*!
 * \brief Module container of PELI.
 */
class Module {
 public:
  Module() {}
   ...
   */
  PELI_DLL void Import(Module other);
  /*!
   ...
   */
  PELI_DLL static Module LoadFromFile(const std::string& file_name,
...
class ModuleNode {
 public:
   ...
   * \param format The format of the file.
   */
  PELI_DLL virtual void SaveToFile(const std::string& file_name,
                                  const std::string& format);
  /*!
   ...
   */
  PELI_DLL virtual void SaveToBinary(dmlc::Stream* stream);
  /*!
   * \brief Get the source code of module, when available.
   * \param format Format of the source code, can be empty by default.
   * \return Possible source code when available.
   */
  PELI_DLL virtual std::string GetSource(const std::string& format = "");
  /*!
   ...
   */
  PELI_DLL const PackedFunc* GetFuncFromEnv(const std::string& name);
...
constexpr const char* peli_module_ctx = "__peli_module_ctx";
/*! \brief Global variable to store device module blob */
constexpr const char* peli_dev_mblob = "__peli_dev_mblob";
/*! \brief Number of bytes of device module blob. */
constexpr const char* peli_dev_mblob_nbytes = "__peli_dev_mblob_nbytes";
/*! \brief global function to set device */
constexpr const char* peli_set_device = "__peli_set_device";
/*! \brief Auxiliary counter to global barrier. */
constexpr const char* peli_global_barrier_state = "__peli_global_barrier_state";
/*! \brief Prepare the global barrier before kernels that uses global barrier. */
constexpr const char* peli_prepare_global_barrier = "__peli_prepare_global_barrier";
/*! \brief Placeholder for the module's entry function. */
constexpr const char* peli_module_main = "__peli_main__";
}  // namespace symbol
