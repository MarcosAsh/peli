 ...
 */
#ifndef PELI_RUNTIME_NODE_BASE_H_
#define PELI_RUNTIME_NODE_BASE_H_
 ...
 * Do not call create raw Node pointer, always use peli::make_node.
 *
 * \note In most cases, please inheritate peli::Node.
...
#endif  // PELI_RUNTIME_NODE_BASE_H_