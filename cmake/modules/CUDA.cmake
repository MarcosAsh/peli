...
if(CUDA_FOUND)
  ...
  add_definitions(-DPELI_USE_CUDA)
endif(CUDA_FOUND)
...
if(USE_CUDA)
  ...
  list(APPEND PELI_LINKER_LIBS ${CUDA_NVRTC_LIBRARY})
  list(APPEND PELI_RUNTIME_LINKER_LIBS ${CUDA_CUDART_LIBRARY})
  list(APPEND PELI_RUNTIME_LINKER_LIBS ${CUDA_CUDA_LIBRARY})
  list(APPEND PELI_RUNTIME_LINKER_LIBS ${CUDA_NVRTC_LIBRARY})
  list(APPEND PELI_RUNTIME_LINKER_LIBS ${CUDA_NVIDIA_ML_LIBRARY})
  list(APPEND PELI_RUNTIME_LINKER_LIBS ${CUDA_NVCUVID_LIBRARY})
