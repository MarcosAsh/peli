...
from .ndarray import PELIContext
...
class VideoLoader(object):
    ...
    uris : list of str
        List of video paths.
    ctx : peli.Context or list of Context
    ...
    def __init__(self, uris, ctx, shape, interval, skip, shuffle, prefetch=0):
        ...
        if isinstance(ctx, PELIContext):
            ctx = [ctx]
        for _ctx in ctx:
            assert isinstance(_ctx, PELIContext)
