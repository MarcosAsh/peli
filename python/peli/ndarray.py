"""PELI Runtime NDArray API.

peli.ndarray provides a minimum runtime array structure to be
used with C++ library.
"""
...
from ._ffi.ndarray import PELIContext, PELIType, NDArrayBase
from ._ffi.ndarray import context, empty, from_dlpack, numpyasarray
from ._ffi.ndarray import _set_class_ndarray

class NDArray(NDArrayBase):
    """Lightweight NDArray class for PELI framework."""
    def __len__(self):
